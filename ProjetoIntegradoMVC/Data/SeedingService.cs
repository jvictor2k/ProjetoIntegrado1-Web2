...
using ProjetoIntegradoMVC.Models.Enums;

namespace ProjetoIntegradoMVC.Data
{
    public class SeedingService
    {
        private ProjetoIntegradoMVCContext _context;

        public SeedingService(ProjetoIntegradoMVCContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Department d1 = new Department(1, "Faca");
            Department d2 = new Department(2, "Luva");
            Department d3 = new Department(3, "Agente");
            Department d4 = new Department(4, "Glock");

            Seller s1 = new Seller(1, "Ney", "neyruto@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Niko", "s1mplesup@gmail.com", new DateTime(1987, 6, 9), 1000.0, d1);
            Seller s3 = new Seller(3, "Limas", "empurra@gmail.com", new DateTime(2000, 7, 8), 1000.0, d1);
            Seller s4 = new Seller(4, "Buda", "segue7k@gmail.com", new DateTime(1988, 11, 19), 1000.0, d1);
            Seller s5 = new Seller(5, "Stewie", "smokecriminal@gmail.com", new DateTime(1979, 12, 3), 1000.0, d1);
            Seller s6 = new Seller(6, "Art", "cachorrada@gmail.com", new DateTime(1996, 5, 20), 1000.0, d1);
